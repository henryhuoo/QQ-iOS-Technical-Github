...
1、对于给枚举类型变量赋整型值的错误，增加强制转换。

2、nil赋值给整型变量的情况统一把nil改为0。

3、typeof统一替换为__typeof。

4、其他由于类型不匹配导致的错误都统一使用强制转换处理。
...
![presentation1](resource/1569294019_8_w750_h1334.png)
...
![full](resource/1569293996_67_w3124_h644.jpg)
Full-Screen模式


![sheet](resource/1569293981_55_w3142_h670.jpg)
Sheet模式
...
![5.3](resource/5.3.1.png)
![5.3](resource/6.3.png)
